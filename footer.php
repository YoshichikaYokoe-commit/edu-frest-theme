<footer style="background:#333; color:#fff; padding:40px 0; font-size:14px;">
  <div style="width:80%; max-width:1200px; margin:0 auto; display:flex; flex-wrap:wrap; justify-content:space-between; gap:20px; box-sizing:border-box;">

    <div style="flex:1; min-width:200px;">
      <p>運営会社：サイマンテクノロジー</p>
      <p>代表：横江誼衡</p>
      <p>代表者メール：<a href="mailto:yokoe@scimtech.sakura.ne.jp" style="color:#fff; text-decoration:underline;">yokoe@scimtech.sakura.ne.jp</a></p>
      <p>電話番号：090-3853-9546</p>
    </div>
